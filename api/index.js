...
// admin.initializeApp({
//   credential: admin.credential.applicationDefault(), // or provide your service account credentials here
// });
...
io.on("connection", (socket) => {
  ...
  io.on("connection", (socket) => {
    console.log(`Socket ${socket.id} connected!`);
    socket.on("notification:updateStatus", async (data) => {
      io.emit("notification:updateStatus", data);
    });
    socket.on("notification:delete", async (data) => {
      io.emit("notification:delete", data);
    });
